...
export REPO_DIR
export MANIFEST="${MANIFEST:-tuning_manifests/roberta_qnli_stratified_client_count_rank4_seed0_e20_r150.tsv}"
export RUN_ROOT="${RUN_ROOT:-./epoch_round_tuning_qnli_client_count}"
