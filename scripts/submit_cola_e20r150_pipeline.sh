...
export REPO_DIR
export MANIFEST="${MANIFEST:-tuning_manifests/roberta_cola_stratified_flora_ffa_rank4_seed0_e20_r150.tsv}"
export RUN_ROOT="${RUN_ROOT:-./epoch_round_tuning_cola_client_count}"
export JOB_PREFIX="${JOB_PREFIX:-cola_e20r150}"
